...
const CartScreen = () => {
  ...
  const checkoutHandler = () => {
    // direct user to log in if not logged in, otherwise, direct to shipping
          ...
          { cartItems.map((item) => (
            <ListGroup.Item key={item._id}>
              <Row>
                ...
                <Col md={2}>
                {/* use a function to call removeFromCartHandler, otherwise it will be called automatically without clicking */}
